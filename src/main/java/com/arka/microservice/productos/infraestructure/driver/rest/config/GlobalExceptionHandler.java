package com.arka.microservice.productos.infraestructure.driver.rest.config;

import com.arka.microservice.productos.domain.exception.BusinessException;
...
import com.arka.microservice.productos.infraestructure.driver.rest.dto.resp.ErrorResponse;
...
public class GlobalExceptionHandler implements ErrorWebExceptionHandler {
    ...
    public Mono<Void> handle(ServerWebExchange exchange, Throwable ex) {
        // Añadimos log para que se registren todos los errores
        log.error("Exception caught in global error handler: {}", ex.getMessage(), ex);

        // Si la respuesta ya fue comprometida, retornamos el error
        ...
        if (ex instanceof BusinessException businessException) {
            // Manejamos excepciones de negocio customizadas
            ...
            // Manejamos ResponseStatusException de Spring
